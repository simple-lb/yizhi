...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "5f9a8676-3-" + i0 + "-" + i1 + "," + ("5f9a8676-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "5f9a8676-2-" + i0 + "-" + i1 + "," + ("5f9a8676-1-" + i0)
          };
        }),
        b: "5f9a8676-1-" + i0 + ",5f9a8676-0",
        c: "5f9a8676-4-" + i0 + ",5f9a8676-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "5f9a8676-0"),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/22753/Documents/HBuilderProjects/uni-starter/pages/ucenter/read-news-log/read-news-log.vue"]]);
